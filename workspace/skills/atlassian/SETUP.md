...
> URL, host, SSL-флаги уже прокинуты Оркестратором из `.env` хоста и лежат в
...
>   вычислений.
>
> Если URL/SSL отсутствует в конфиге — это баг конфига Оркестратора. Скажи
> пользователю «Оркестратор не прокинул `<FIELD>` — напиши админу» и стоп.
> Хост сам не гадай.
